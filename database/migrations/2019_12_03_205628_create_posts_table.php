...
class CreatePostsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $data = array(
            ...
            'created_at'=> '2019-12-5 16:50:20', 'updated_at'=> '2019-12-6 17:45:12', 'user_id'=>'1'),
            array('title'=>'Running Migrations', 'body'=>'To run all of your outstanding migrations, execute the migrate Artisan command.',
            'created_at'=> '2019-12-08 13:45:10', 'updated_at'=> '2019-12-08 13:45:10', 'user_id'=>'2'),
            ...
            'created_at'=> '2019-12-10 17:42:04', 'updated_at'=> '2019-12-10 17:42:04', 'user_id'=>'2'),
            array('title'=>'Hello World', 'body'=>'Welcome to the greatest pratice ever.',
            'created_at'=> '2020-02-20 17:42:04', 'updated_at'=> '2020-02-26 13:05:04', 'user_id'=>'1'),
        );
        Post::insert($data);
    }
